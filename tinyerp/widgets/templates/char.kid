<span xmlns:py="http://purl.org/kid/ns#" py:strip="">
    <input py:if="editable" type="${invisible and 'password' or 'text'}" kind="${kind}" name='${name}' id='${field_id}' value="${value}" class="${field_class}" py:attrs="attrs" callback="${callback}" onchange="${onchange}"/>    
