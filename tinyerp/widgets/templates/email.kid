	...
	<table py:if="editable" width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td width="16" style="padding-left: 2px">
                <img width="16" height="16" alt="${_('Go!')}" src="/static/images/stock/gtk-jump-to.png" style="cursor: pointer;" onclick="if (echeck($('${field_id}').value)) window.open('mailto:' + $('${field_id}').value).close();"/>
    		</td>
    	</tr>
    </table>
