            ...
            <div class="toolbar">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td align="right">
                            <button type="button" title="Create new record..." py:if="screen.editable" onclick="newO2M('${name}', '${screen.view_mode[0]}', ${(screen.view_mode[0] == 'tree' or 0) and len(screen.widget.editors)})">New</button>
