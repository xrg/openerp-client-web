                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <button type="button" title="Translate me." py:if="not screen.editable and screen.view_type=='form'" onclick="openWindow('${tg.url('/translator', _terp_model=screen.model, _terp_id=screen.id)}')">i18n</button>
                        </td>
                    </tr>
                </table>
            </div>
