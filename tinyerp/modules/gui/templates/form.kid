                            ...
                            <table width="100%" class="titlebar">
                                <tr>
                                    ...
                                    <td align="center" valign="middle" width="16">
                                        <a target="new" href="${tg.query('http://tinyerp.org/scripts/context_index.php', model=form.screen.model, lang=rpc.session.context.get('lang', 'en'))}"><img border="0" src="/static/images/stock/gtk-help_16x16.png" width="16" height="16"/></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
