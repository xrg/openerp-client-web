<div id="search_filter_data">
	...
	% if not source:
        <tr>
           <td style="padding: 0 2px 0 3px;">
                <div style="padding: 0 0 0 3px;" id="filters" onclick="collapse_expand(this, '#filter_option_table');" class="group-expand"><h2>Filters</h2></div>
