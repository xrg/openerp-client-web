            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="${name}_btn_" title="${new_attrs['help']}" onclick="new One2Many('${name}', ${(screen.view_type == 'tree' or 0) and len(screen.widget.editors)}).create()">
                            % if parent_id:
                        ...
                        <button type="button" title="${_('Previous record...')}" onclick="submit_form('previous', '${name}')" style="padding: 2px">
                            <img class="button" src="/openerp/static/images/stock/gtk-go-back.png" width="16" height="16"/>
                        </button>
                        % endif
                    </td>
                    % if pager_info:
                    ...
                    <td>
                        ...
                        <img class="button" title="${_('Translate me.')}" src="/openerp/static/images/stock/stock_translate.png" width="16" height="16" onclick="openobject.tools.openWindow('${py.url('/translator', _terp_model=screen.model, _terp_id=screen.id)}')"/>
                        % endif
                    </td>
                </tr>
            </table>
