<div id="MiniCalendar">
    <table class="calMini" width="100%" cellpadding="2" cellspacing="1" border="0">
        <tr class="calMiniHeader">
            <td nowrap="nowrap"><img height="16" width="16" class="button" src="${cp.static('base', 'images/stock/gtk-go-back.png')}" onclick="getMiniCalendar('${py.url('/calendar/mini', year=month.prev().year, month=month.prev().month, forweek=forweek)}')"/></td>
            ...
            <td nowrap="nowrap"><img height="16" width="16" class="button" src="${cp.static('base', 'images/stock/gtk-go-forward.png')}" onclick="getMiniCalendar('${py.url('/calendar/mini', year=month.next().year, month=month.next().month, forweek=forweek)}')"/></td>
        </tr>
