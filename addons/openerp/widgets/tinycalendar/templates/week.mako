...
<tr>
    ...
    <td id="calNavigation">
        <table width="100%" class="toolbar">
            <tr>
                <td nowrap="nowrap"><img height="16" width="16" class="button" src="${cp.static('openerp', 'images/stock/gtk-go-back.png')}" onclick="getCalendar('${week.prev()[0].isoformat()}')"/></td>
                <td nowrap="nowrap"><button type="button" title="${_('Today...')}" onclick="getCalendar('${selected_day.today().isoformat()}', 'day')">${_("Today")}</button></td>
                <td nowrap="nowrap"><img height="16" width="16" class="button" src="${cp.static('openerp', 'images/stock/gtk-go-forward.png')}" onclick="getCalendar('${week.next()[0].isoformat()}')"/></td>
