...
openobject.workflow.Toolbar.implement({
    ...
    createHTMLElement : function() {
        ...
        if (this.hasTitleBar()) {        	
            this.titlebar.style.backgroundImage = "url(/openerp/static/workflow/images/window_toolbar.png)";
        }
...
openobject.workflow.ToolShowGrid = openobject.workflow.ToolToggle.extend({
    ...
    initialize : function(palette) {
        this.parent(palette, '/openerp/static/workflow/images/ToolShowGrid.jpg');
    },

    execute : function() {
        var isdown = this.isDown();
        
        WORKFLOW.setBackgroundImage(isdown ? '/openerp/static/workflow/images/grid_10.jpg' : null, isdown);
