<table border="0" id="_o2m_${name}" width="100%" class="one2many">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" title="${new_attrs['help']}" onclick="new One2Many('${name}', ${(screen.view_type == 'tree' or 0) and len(screen.widget.editors)}).create()" style="padding: 2px">
                            % if parent_id:
                            <img src="/static/images/stock/gtk-new.png" width="16" height="16"/>
                            % endif
                            % if not parent_id:
                            <img src="/static/images/stock/gtk-save.png" width="16" height="16"/>
                            % endif
                        </button>
                        % endif
    ...
    <tr>
        ...
        <td>
            ...
            <input type="hidden" name="${name}/_terp_default_get_ctx" id="${name}/_terp_default_get_ctx" value="${py.content(default_get_ctx)}"/>
            ${screen.display()}
        </td>
        % endif
    </tr>
