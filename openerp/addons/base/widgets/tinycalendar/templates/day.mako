...
<tr>
    ...
    <td id="calNavigation">
        <table width="100%" class="toolbar">
            <tr>
                <td nowrap="nowrap"><img height="16" width="16" class="button" src="${py.url('/static/images/stock/gtk-go-back.png')}" onclick="getCalendar('${day.prev().isoformat()}')"/></td>
                ...
                <td nowrap="nowrap"><img height="16" width="16" class="button" src="${py.url('/static/images/stock/gtk-go-forward.png')}" onclick="getCalendar('${day.next().isoformat()}')"/></td>
