...
<%def name="header()">
    <title>About the OpenERP Web</title>
</%def>
...
<table width="100%">
        <tr>
            <td class="titlebar">OpenERP Web</td>
        </tr>
        <tr>
            <td>
            <b>${version}</b>
...
client.
        ...
        <tr>
            <td width="100%" class="titlebar">Links</td>
        </tr>
        <tr>
            <td>
<ul>
                    ...
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td style="color: white; font-weight: bold; font-size: 12px; background-color: #363636">RESOURCES</td>
